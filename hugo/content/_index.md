...
- **Multi-format support**: PDF, DOCX, EPUB, ODT, TXT, and Markdown
- **Adjustable speed**: 100 to 1000+ WPM with keyboard shortcuts
- **Position saving**: Resume reading where you left off
- **Privacy-first**: Documents are processed locally
- **Cross-platform**: Works on Linux, macOS, and Windows
- **Web & TUI**: Choose your preferred interface
